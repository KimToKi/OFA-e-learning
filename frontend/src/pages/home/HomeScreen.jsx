...
const videos = [
    {
        ...
        snippet: {
            title: "ตัวอย่างวิดีโอจาก YouTube",
            description: "นี่คือคำอธิบายตัวอย่างวิดีโอจาก YouTube",
            thumbnails: {
                high: {
                    url: "https://i.ytimg.com/vi/wdsc_QfFL2E/hqdefault.jpg", // ภาพ thumbnail จาก videoId
                },
            },
            publishedAt: "2023-10-01T00:00:00Z", // วันที่เผยแพร่ (กำหนดเอง)
        },
    },
];

const HomeScreen = () => {
    const [trendingVideo, setTrendingVideo] = useState(videos[0]); // เลือกวิดีโอแรกเป็นตัวอย่าง
